...
- Methods for reasoning while learning from software data.
- Methods for learning (including large language models) while reasoning about software artifacts and tasks, e.g., automatically & adaptively determine decision thresholds and magnitude of actions for a desired effect of a software tool & technique.
